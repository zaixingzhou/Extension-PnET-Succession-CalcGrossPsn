...
namespace Landis.Extension.Succession.BiomassPnET
{
    public class Parameter<T> : IEnumerable<KeyValuePair<string, T>>  
    {
        ...
        public static explicit operator Landis.Library.Parameters.Ecoregions.AuxParm<T>(Parameter<T> m)
        {
            ...
            try
            {
                Landis.Library.Parameters.Ecoregions.AuxParm<T> newvalues = new Landis.Library.Parameters.Ecoregions.AuxParm<T>(PlugIn.ModelCore.Ecoregions);
        ...
        public static explicit operator Landis.Library.Parameters.Species.AuxParm<T>(Parameter<T> m)
        {
            ...
            try
            {
                Landis.Library.Parameters.Species.AuxParm<T> newvalues = new Library.Parameters.Species.AuxParm<T>(PlugIn.ModelCore.Species);
